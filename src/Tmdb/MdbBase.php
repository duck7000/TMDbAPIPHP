...
class MdbBase extends Config
{
    ...
    public function __construct(?Config $config = null, ?LoggerInterface $logger = null, ?CacheInterface $cache = null)
    {
        ...
        if (!empty($this->config->apiToken)) {
            ...
            $this->logger->error("Invalid API Token in Config Class, probably empty?");
            throw new \Exception("Invalid API Token in Config Class, probably empty?");
        }
    }
     ...
     * @param string $countyryCode input country code like US
     * @return string|false
     */
    protected function countryCodeToName($countyryCode)
    {
        $countryList = [
        'AF' => 'Afghanistan',
        'AX' => 'Åland Islands',
        ...
        if (array_key_exists($countyryCode, $countryList)) {
            return $countryList[$countyryCode];
        } else {
            return false;
        }
    }
